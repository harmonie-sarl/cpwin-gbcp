...
public class Util {
	...
	private static Map<String,String> getSpecialCaracteres(){
		...
		CARACTERES_SPECIAL.put("�", "o");CARACTERES_SPECIAL.put("�", "o");
		CARACTERES_SPECIAL.put("�", "e");CARACTERES_SPECIAL.put("�", "e");
		CARACTERES_SPECIAL.put("�", "e");
		CARACTERES_SPECIAL.put("�", "a");CARACTERES_SPECIAL.put("�", "a");CARACTERES_SPECIAL.put("�", "a");
		CARACTERES_SPECIAL.put("�", "s");
		CARACTERES_SPECIAL.put("�", "u");CARACTERES_SPECIAL.put("�", "u");
		CARACTERES_SPECIAL.put("�", "c");
