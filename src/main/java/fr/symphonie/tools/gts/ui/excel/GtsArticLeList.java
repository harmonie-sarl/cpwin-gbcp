...
public class GtsArticLeList implements ExcelDocType{

	@Override
	public String[] getColumnsKey() {
		String[] columnskey = new String[] { 
				MsgEntry.MENU_ARTICLE,MsgEntry.MNT_TOTAL,MsgEntry.DONT_REGISSEUR, MsgEntry.DONT_CLIENT };
				return columnskey;
	}

	@Override
	public String getTitle() {
		return HandlerJSFMessage.getMessageByKey(MsgEntry.RECET_CODE_ARTICLE);
	}
