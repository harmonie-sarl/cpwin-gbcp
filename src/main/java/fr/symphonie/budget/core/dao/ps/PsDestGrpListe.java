...
public class PsDestGrpListe extends GenericBudgetPs{

	
	

	private static PsDestGrpListe instance=null;
	public static final String SP_NAME="PsDestGrpListe";
	private static final Logger logger = LoggerFactory.getLogger(PsDestGrpListe.class);
	...
	/**
			    ...
			    @dest_grp			TCODE	= null,		 groupe destination 
			    @code_dest			TCODE	= null,		 destination 
			    @nat_grp			TCODE	= null,		 groupe nature (non utilisé) 
	...
	**/		
	...
	protected PsDestGrpListe(JdbcTemplate jdbcTemplate) {
...
//	psDestGrpListe 3, Exercice CP, Budget, '', '', '', '', '', '', '', 1, 1, 1, Profil Central [Booléan], null, 0, null, Utilisateur	
...
//				inputs.put(STYLE, 2);
		...
		public static PsDestGrpListe getInstance(JdbcTemplate jdbcTemplate) {
			if(instance==null)instance=new PsDestGrpListe(jdbcTemplate);
			return instance;
		}
