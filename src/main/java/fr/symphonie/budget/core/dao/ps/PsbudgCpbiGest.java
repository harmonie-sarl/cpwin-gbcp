...
public class PsbudgCpbiGest  extends GenericPs{
	private static PsbudgCpbiGest instance=null;
	public static final String SP_NAME="PsbudgCpbiGest";
	private static final Logger logger = LoggerFactory.getLogger(PsbudgCpbiGest.class);
	private static final String RESULT_LIST = "RESULT_LIST";
	private static final String NAT_GRP = "@nat_grp";

	protected PsbudgCpbiGest(JdbcTemplate jdbcTemplate) {
		super(jdbcTemplate, SP_NAME);
		RowMapper<CpGestionnaire> rowMapper=new CpBiGestRowMapper();
	...
	public static PsbudgCpbiGest getInstance(JdbcTemplate jdbcTemplate) {
		if(instance==null)instance=new PsbudgCpbiGest(jdbcTemplate);
		return instance;
	}
