...
public class PsNatListe extends GenericBudgetPs {

	private static PsNatListe instance = null;
	public static final String SP_NAME = "PsNatListe";
	private static final Logger logger = LoggerFactory.getLogger(PsNatListe.class);
	 ...
	 * @dest_grp TCODE = null, groupe de fongibilité de destinations (non
	 *           utilisé)
	 * @code_dest TCODE = null, destination (non utilisé)
	 * @code_prog TCODE = null, programme (non utilisé)
	 * @nat_grp TCODE = null, groupe de fongibilité de natures
	 * @code_nature TCODE = null, nature
	 ...
	 * @central bit = 0,
	 * @fongible int = null,
	 * @consult bit = 0, si 1 : seulement les BudgInterneLignes (le cas échéant)
	 *          qui ont actions=0)
	...
	protected PsNatListe(JdbcTemplate jdbcTemplate) {
		...
		RowMapper<Map<String, Object>> rowMapper = new RowMapper<Map<String, Object>>() {
			...
			public Map<String, Object> mapRow(ResultSet rs, int rowNum) throws SQLException {
				...
				map.put(nom_nature_col, rs.getString(nom_nature_col));
...
//	psNatListe 2, Exercice CP, Budget, Fong.Dest., Destination, Programme, '', '', '', Direction, Service, 1, 1, 1, Profil Central [Booléan], null, 0, Utilisateur		
	
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>>getData(int numexec, String codeBudg , String codeFongDest, String codeDest,String codeProg,String codeNatureGrp,String codeDirection, String codeService){
			logger.debug("getData - start");
				...
				inputs.put(nat_grp, codeNatureGrp);
		...
		public static PsNatListe getInstance(JdbcTemplate jdbcTemplate) {
			if(instance==null)instance=new PsNatListe(jdbcTemplate);
			return instance;
		}
