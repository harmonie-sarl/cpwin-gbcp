...
public class LigneBudgPK implements Serializable {
	private static final long serialVersionUID = 8505500478617445867L;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof LigneBudgPK))
			return false;
		LigneBudgPK other = (LigneBudgPK) obj;
		if (codeBudget == null) {
