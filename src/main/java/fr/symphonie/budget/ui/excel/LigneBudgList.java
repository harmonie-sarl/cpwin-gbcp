...
public class LigneBudgList implements ExcelDocType {

	@Override
	public String[] getColumnsKey() {
		String[] columnskey = new String[] { MsgEntry.NATRURE_DESTINATION,MsgEntry.SERVICE,
	...
	public String getTitle() {
		return HandlerJSFMessage.getMessageByKey(MsgEntry.LIGN_BUDG_REPORT_TITRE);
		}
