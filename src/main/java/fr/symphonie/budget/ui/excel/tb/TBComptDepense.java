...
public class TBComptDepense implements ExcelDocType{
	...
	public String getTitle() {
		return HandlerJSFMessage.getMessageByKey(MsgEntry.MENU_COMPTE_COMPTBLE_DEP);
	}
...
//		tbDocx.generalData(context, tbStruct);
		context= tbDocx.getCompteDepense(tbStruct);
		 tbDocx.generalData(context, tbStruct);
		return context;
	}
	@Override
