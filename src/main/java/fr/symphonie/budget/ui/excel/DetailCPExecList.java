...
public class DetailCPExecList implements ExcelDocType{

	@Override
	public String[] getColumnsKey() {
		String[] columnskey = new String[] {MsgEntry.CODE_DEST,MsgEntry.CODE_NAT,MsgEntry.CODE_SERV,MsgEntry.CODE_PROG,MsgEntry.NOM_PROG,MsgEntry.NUM_EJ,MsgEntry.MONTANT,
	...
	public String getTitle() {
		return HandlerJSFMessage.getMessageByKey(MsgEntry.SUR_AE_EXEC);
