...
public class TBComptRecette implements ExcelDocType{
	...
	public String getTitle() {
		return HandlerJSFMessage.getMessageByKey(MsgEntry.MENU_PAR_COMPRECV2);
	}
...
//		tbDocx.generalData(context, tbStruct);
		context= tbDocx.getSuiviCompteRecette(tbStruct);
		 tbDocx.generalData(context, tbStruct);
		return context;
	}
